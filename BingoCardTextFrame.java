...
public class BingoCardTextFrame extends JFrame implements ActionListener {
	...
	private JLabel label1, label2, label3, label4, label5, instructions1, instructions2, instructions3;
	...
	public BingoCardTextFrame(String framename) {
		...
		instructions1 = new JLabel("Instructions: After clicking on Generate:");
		instructions1.setSize(1000, 100);
		instructions1.setLocation(20, 240);
		win.add(instructions1);
		
		instructions2 = new JLabel("Click on screen to generate the ball to get 5 in a row for the Bingo Cards");
		instructions2.setSize(1000, 100);
		instructions2.setLocation(20, 260);
		win.add(instructions2);
		
		instructions3 = new JLabel("Have fun!");
