...
//		graphics.setColor(new Color(123, 234, 123));
		...
		if(winnersCount >= numberOfWinners) {
			...
			for(int i = 0; i < 15; i++) {
				graphics.drawString(arrJustForHere[i]+", ", 700+20*i, 600);
			}
			for(int i = 15; i < 30; i++) {
				graphics.drawString(arrJustForHere[i]+", ", 700+20*(i-15), 640);
			}
			for(int i = 30; i < 45; i++) {
				graphics.drawString(arrJustForHere[i]+", ", 700+20*(i-30), 680);
			}
			for(int i = 45; i < 60; i++) {
				graphics.drawString(arrJustForHere[i]+", ", 700+20*(i-45), 720);
			}
			for(int i = 60; i < 75; i++) {
				graphics.drawString(arrJustForHere[i]+", ", 700+20*(i-60), 726);
			}
			return;
		}
		//drawing the image
